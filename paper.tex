...
\title{電子フォーム作成時間の削減を目的とした\\帳票画像における記入欄自動検出ツールの試作\\}
\author{木村 優哉}
\nendo{5} % 年度
...
\begin{thebibliography}{0}
  ...
  \bibitem{バリデーションチェック}Angular 開発ガイド フォーム: "フォーム入力のバリデーション"\\\url{https://angular.jp/guide/form-validation}\\アクセス日: 2024/01/09.
