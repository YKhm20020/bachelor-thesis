...
\title{電子フォーム作成を目的とした\\記入欄検出およびラベル付与ツールの試作\\}
\author{木村 優哉}
\nendo{5} % 年度
...
% そこで本研究は、帳票のレイアウトを変更せず、電子フォーム作成にかかる手間と時間を削減することを目的として、記入欄検出およびラベル付与ツールを試作する。
...
% その理由は、電子フォーム記入欄の削除による修正回数が、配置による修正回数と比較して多いことであるため、電子フォーム作成にかかる手間を削減できることを確認した。
